    ...
    <div className="space-y-6">
      ...
      <nav className="flex" aria-label="Breadcrumb">
        <ol className="flex items-center space-x-2 text-sm">
          <li>
            <Link href="/editor/dashboard" className="text-gray-500 hover:text-indigo-600 transition-colors">
          ...
          <li>
            <Link href="/editor/blog" className="text-gray-500 hover:text-indigo-600 transition-colors">
              My Posts
            </Link>
          </li>
          <li>
